...
export default function EditBook({findAuthors, categories, authors, editBook}){
    ...
    useEffect(() => {
        findAuthors();
        setAuthorDialogValue(history.location.state.entity.author)
    }, [])
    ...
    return (
        <div>
            <Formik
                enableReinitialize
                initialValues={
                    { name: history.location.state.entity.name, category: history.location.state.entity.category, author: authorDialogValue, availableCopies: history.location.state.entity.availableCopies}
                } onSubmit={(values, {setSubmitting}) => {
                setSubmitting(true);
                editBook(history.location.state.entity.id,values.name, values.category, values.author, values.availableCopies);
                setSubmitting(false);
                history.push('/books');
            }
            }
